...
def run_forecasts(instruments=['SPX', 'NDX', 'SMH', 'GC', 'CVX', 'XOM', 'BTCUSD', 'DBC'], start_year=1962, subfolder='stevenmichiels.github.io'):
...
if __name__ == "__main__":
    ...
    if is_jupyter:
        ...
        run_forecasts(instruments=['SPX', 'NDX', 'SMH', 'GC', 'CVX', 'XOM', 'BTCUSD', 'DBC'], start_year=1962)
    else:
