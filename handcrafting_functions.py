...
def calc_pd_diversification_mult(corr_matrix,vol_weights ):
        ...
        :return:calc_pd_diversification_mult
         float
        """
...
class Portfolio:
    ...
    def _calculate_weights_aggregated_portfolio(self):
        ...
        if self.overwrite_weights!=[]:
            vol_weights=self.overwrite_weights
    ...
    def _calculate_cash_weights_with_risk_target(self):
        ...
        print("Calculating weights to hit a risk target of %f" % target_std)
